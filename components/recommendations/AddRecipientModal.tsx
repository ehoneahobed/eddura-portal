...
export default function AddRecipientModal({ onRecipientAdded, trigger }: AddRecipientModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        onRecipientAdded(data.recipient);
        setOpen(false);
        // Reset form
        setFormData({
          name: '',
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[800px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new professor, supervisor, or manager who can write recommendation letters for you.
          </DialogDescription>
        </DialogHeader>
