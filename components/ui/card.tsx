...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-eddura-100 bg-white text-eddura-900 shadow-sm transition-all duration-200 ease-in-out hover:shadow-eddura-lg hover:border-eddura-200 dark:bg-eddura-800 dark:text-eddura-100 dark:border-eddura-700 dark:hover:border-eddura-600",
      className
    )}
    {...props}
  />
...
>(({ className, variant = 'default', ...props }, ref) => {
  const variantClasses = {
    default: "border-eddura-100 bg-white shadow-sm hover:shadow-eddura-lg hover:border-eddura-200 dark:bg-eddura-800 dark:text-eddura-100 dark:border-eddura-700 dark:hover:border-eddura-600",
    elevated: "border-eddura-200 bg-white shadow-eddura hover:shadow-eddura-xl hover:border-eddura-300 dark:bg-eddura-800 dark:text-eddura-100 dark:border-eddura-700 dark:hover:border-eddura-600",
